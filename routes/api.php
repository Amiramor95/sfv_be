...
Route::group(['prefix' => 'staff-management'], function () {
    ...
    Route::post('/UserProfile', [StaffManagementController::class, 'UserProfile']);
    Route::post('/UserUpdateProfile', [StaffManagementController::class, 'UserUpdateProfile']);
...
Route::group(['prefix' => 'appointment-request'], function () {
    ...
    Route::post('/remove', [AppointmentRequestController::class, 'removeRequestList']);
});
...
Route::group(['prefix' => 'faqCategory'], function () {
    ...
    Route::post('/fetch', [FaqCategoryController::class, 'fetch']);
    Route::post('/faqCategoryList', [FaqCategoryController::class, 'getListCategory']);
    Route::post('/faqCategoryAll', [FaqCategoryController::class, 'getAllCategory']);
});
